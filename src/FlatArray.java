...
public	class	FlatArray<T> extends ahp.org.Containers.Container<T> implements Serializable {
	...
	public	T get(int ... acoordinates){
		...
		if( debug ){ System.out.println("FlatArray.java: get()/1 : content size: "+this.myContent.length+", index="+a_linear_index+", coord="+Arrays.toString(acoordinates)); }
	...
	public	T get_with_linear_index(int a_linear_index){
		if( debug ){ System.out.println("FlatArray.java: get_with_linear_index() : content size: "+this.myContent.length+", index="+a_linear_index); }
		if( a_linear_index < this.myContent.length ){
			return this.myContent[a_linear_index];
		}
		return null;
	...
	public	int put(
		...
		if( debug ){ System.out.println("FlatArray.java: put() : content size: "+this.myContent.length+", index="+a_linear_index+", coord="+Arrays.toString(acoordinates)); }
